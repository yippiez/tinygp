...
class PersistentES:
    """Persistent-noise evolution strategy.

    Algorithm:
    - Maintain perturbation directions across consecutive iterations.
    - Evaluate trajectories generated by repeatedly applying persistent directions.
    - Estimate updates using accumulated fitness feedback over those trajectories.
    - Refresh persistence periodically to avoid stale bias.

    Intuition:
        Temporal noise reuse can improve credit assignment over longer horizons and reduce variance compared with fully independent perturbations.
    """
